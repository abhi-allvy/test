...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="GHSSD : Deomali Higher Sec School" />
	
	<!-- OG -->
	<meta property="og:title" content="GHSSD : Deomali Higher Sec School" />
	<meta property="og:description" content="GHSSD : Deomali Higher Sec School" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>GHSSD : Deomali Higher Sec Schoole </title>
		...
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-logo-box">
				<div>
					<a href="index.html" class="ttr-logo">
						<img class="ttr-logo-mobile" alt="" src="" width="30" height="30">
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<ul class="ttr-header-navigation">
					...
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="assets/images/testimonials/admin.png" width="32" height="32"></span></a>
						<div class="ttr-header-submenu">
							<ul>
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<div class="ttr-sidebar-logo">
				<a href="#"><img alt="" src="" width="122" height="27"></a>
